...
$config = include __DIR__ . '/config.php';  // adapte le chemin selon ton dossier
// MySQL Example:
...
// In development, use PdoQueryCapture to log queries; in production, use PdoWrapper for performance.$pdoClass = Debugger::$showBar === true ? PdoQueryCapture::class : PdoWrapper::class;
